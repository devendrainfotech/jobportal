      ...
      <div class="tab-content">
        <div class="tab-pane fade in active" id="tab1">          
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
				<input id="txtAdminOldPassword" name="txtAdminOldPassword" placeholder="Old Password" class="form-control input-md" required="" type="password">
				<span class="help-block">*</span>
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input id="txtEmailId" name="txtEmailId" placeholder="Email Id" class="form-control input-md" required="" type="text">
			  <span class="help-block">*</span>  
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-5">
			  <input id="txtContactNo" name="txtContactNo" placeholder="Contact No" class="form-control input-md" required="" type="text">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-4">                     
				<textarea class="form-control" id="txtLocation" name="txtLocation"></textarea>
			  </div>
			</div>
			...
			';}}else{
				echo '
			<form class="form-horizontal" action="temp.php" method="POST">
			<fieldset>
			...
			<div class="form-group">
			  <label class="col-md-4 control-label" for="txtAdminName">Admin Name</label>  
			  <div class="col-md-5">
			  <input id="txtAdminName" name="txtAdminName" placeholder="Name" class="form-control input-md" required="" type="text" disabled>
			  <span class="help-block">*</span>  
			  </div>
			</div>
			...
			<div class="form-group">
			  <label class="col-md-4 control-label" for="txtAdminPassword">Admin Old Password</label>
			  <div class="col-md-5">
				<input id="txtAdminOldPassword" name="txtAdminOldPassword" placeholder="Old Password" class="form-control input-md" required="" type="text" disabled>
				<span class="help-block">*</span>
			  </div>
			</div>
			...
			<div class="form-group">
			  <label class="col-md-4 control-label" for="txtEmailId">Email Id</label>  
			  <div class="col-md-5">
			  <input id="txtEmailId" name="txtEmailId" placeholder="Email Id" class="form-control input-md" required="" type="text" disabled>
			  <span class="help-block">*</span>  
			  </div>
			</div>
			...
			<div class="form-group">
			  <label class="col-md-4 control-label" for="txtContactNo">Contact No</label>  
			  <div class="col-md-5">
			  <input id="txtContactNo" name="txtContactNo" placeholder="Contact No" class="form-control input-md" required="" type="text" disabled>
			  <span class="help-block">* &gt; 10 digits</span>  
			  </div>
			</div>
			...
			<div class="form-group">
			  <label class="col-md-4 control-label" for="txtLocation">Location</label>
			  <div class="col-md-4">                     
				<textarea class="form-control input-md" id="txtLocation" name="txtLocation" disabled></textarea>
			  </div>
			</div>
